...
from apps.prepaid.models import InteractionRecord
from apps.prepaid.serializers import InteractionRecordSerializer
...
class InteractionRecordViewSet(viewsets.ModelViewSet):
    ...
    search_fields = ["customer_interaction_prepaid__id"]
