# Generated by Django 3.2.8 on 2023-05-15 20:34
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("post_paid", "0038_ticketsummaryrecord"),
    ]

    operations = [
        migrations.CreateModel(
            name="JobOrderTicketSummary",
            fields=[
                (
                    "id",
                    models.BigAutoField(
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="vas_ticket_summary_job_orders",
        ...
        migrations.CreateModel(
            name="JobOrderTicketSummaryComment",
            fields=[
                (
                    "id",
                    models.BigAutoField(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="post_paid.joborderticketsummary",
                    ),
                ),
                (
                    "user",
