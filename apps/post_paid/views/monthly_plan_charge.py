...
from apps.post_paid.serializers import MonthlyChargeSerializer

User = get_user_model()


__all__ = ("MonthlyChargeViewSet",)
...
class MonthlyChargeViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        if (
            ...
            qs = MonthlyCharge.objects.select_related("client").filter(client=user)
            return qs
