    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_category', models.CharField(blank=True, choices=[('call_me_ph', 'CallMe.Com.Ph'), ('psalms_global', 'PsalmsGlobal.Com'), ('call_me_psalms_global', 'CallMe.Com.Ph/PsalmsGlobal.Com')], max_length=40)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hourly_rate', djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=19, null=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['user__first_name'],
